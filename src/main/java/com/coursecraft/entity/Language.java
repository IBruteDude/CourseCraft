...
public enum Language {
	...
	DUT("dut", "nl", "Dutch; Flemish"),
	DYU("dyu", " ", "Dyula"),
	DZO("dzo", "dz", "Dzongkha"),
	EFI("efi", " ", "Efik"),
	EGY("egy", " ", "Egyptian (Ancient)"),
	EKA("eka", " ", "Ekajuk"),
	GRE("gre", "el", "Greek, Modern (1453-)"),
	ELX("elx", " ", "Elamite"),
	ENG("eng", "en", "English"),
	...
	ROH("roh", "rm", "Romansh"),
	ROM("rom", " ", "Romany"),
	RUM("rum", "ro", "Romanian; Moldavian; Moldovan"),
	RUN("run", "rn", "Rundi"),
	...
	final public String set2Code;
	final public String set1Code;
	final public String languageName;

	Language(String set2Code, String set1Code, String languageName) {
